...
// ************************************************************
		public void drawSmallEyes() {
			...
			// right side outline
//			bufferG2.shear(0.1, 0.1);
			rightEyeOutline = new Polygon();
			int dx = bx + who.getEyeSeparation() + rightSmallX[0];
			int dy = by + rightSmallY[0];
...
// ************************************************************
	public void drawBigIris() {
		...
		rightBigY[0] = y - 4;
		bufferG2.drawImage(ActorFace.getStandardIris(), x, y, FaceEditor.transparent, who);
...
// ************************************************************
	public void drawSmallNose() {
		...
		bufferG2.drawImage(who.getSmallNose(), x - who.getSmallNose().getWidth()/2, y, FaceEditor.transparent, who);
	}
// ************************************************************
	public void drawBigNose() {
		...
		rightBigX[0] = x-4;
		rightBigY[0] = y-4;
		bufferG2.drawImage(ActorFace.getStandardNose(), x - ActorFace.getStandardNose().getWidth()/2, y, FaceEditor.transparent, who);
	}
// ************************************************************
